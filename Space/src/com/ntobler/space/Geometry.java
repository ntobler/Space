...
public class Geometry {
	...
	static Complex getDirection(Complex src, Complex dest) {
		return dest.minus(src).normalVector();
	}
	
	static double getAngle(Complex ba, Complex bc) {
	...
	static double getDistancetoPoint(Complex p1, Complex p2, Complex a) {
